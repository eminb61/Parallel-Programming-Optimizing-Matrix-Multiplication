...
static inline void kernel4by4(int lda, int K, double* A, double* B, double* C) {
    ...
    for (int k = 0; k < K; k++) {
        ...
        C0 = _mm256_add_pd(C0, _mm256_mul_pd(ax,bx0));
        C1 = _mm256_add_pd(C1, _mm256_mul_pd(ax,bx1));
        C2 = _mm256_add_pd(C2, _mm256_mul_pd(ax,bx2));
        C3 = _mm256_add_pd(C3, _mm256_mul_pd(ax,bx3));
        // c00 += a0x * bx0;
        // c01 += a0x * bx1;
        // c02 += a0x * bx2;
        // c03 += a0x * bx3;
